    ...
    const menu = [
        {
            label: 'Home',
            items: [{
                label: 'Vehicles', icon: 'pi pi-fw pi-home', to: '/'
            }, {
                label: 'User', icon: 'pi pi-fw pi-home', to: '/auth'
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <div className="layout-main-container">
                <div className="layout-main">
                    <Route path="/" exact render={() => <Auth colorMode={layoutColorMode} location={location} />} />
