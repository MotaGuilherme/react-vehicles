...
const Vehicle = () => {
    ...
    const objetoService = new VehiclesService();
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <Button label="Novo Vehicle" icon="pi pi-plus" className="p-button-success mr-2" onClick={openNew} />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable ref={dt} value={objetos}
                        ...
                        <Column field="brand" header="Brand" body={brandBodyTemplate} headerStyle={{ width: '14%', minWidth: '10rem' }}></Column>
                    ...
                    <Dialog visible={objetoDialog} style={{ width: '450px' }} header="Cadastrar/Editar" modal className="p-fluid" footer={objetoDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            <InputText id="name" value={objeto.name} onChange={(e) => onInputChange(e, 'name')} required autoFocus className={classNames({ 'p-invalid': submitted && !objeto.name })} />
                            {submitted && !objeto.name && <small className="p-invalid">Name é Obrigatório.</small>}
                        </div>
                        <div className="field">
                            <label htmlFor="brand">Brand</label>
                            <InputText id="brand" value={objeto.brand} onChange={(e) => onInputChange(e, 'brand')} required className={classNames({ 'p-invalid': submitted && !objeto.brand })} />
...
export default React.memo(Vehicle, comparisonFn);
